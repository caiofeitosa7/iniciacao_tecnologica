...
def gerar_pdf_evento_adv_pos_vacina(notificatoriaCSV: dict, dict_especifico: dict, modelo_pdf: str, modelo_pdf_base: str, path_pdf_gerado: str, nome_arquivo: str):
    ...
    ###Coluna 4
    document.write_text(dict_especifico['vacinacao_via_adm1'], (220, 505), font_size=12) # Via de administração da vacina1
    document.write_text(dict_especifico['vacinacao_via_adm2'], (220, 517), font_size=12) # Via de administração da vacina2
    document.write_text(dict_especifico['vacinacao_via_adm3'], (220, 530), font_size=12) # Via de administração da vacina3
    document.write_text(dict_especifico['vacinacao_via_adm4'], (220, 543), font_size=12) # Via de administração da vacina4
    document.write_text(dict_especifico['vacinacao_via_adm5'], (220, 555), font_size=12) # Via de administração da vacina5
    document.write_text(dict_especifico['vacinacao_via_adm6'], (220, 567), font_size=12) # Via de administração da vacina6
    document.write_text(dict_especifico['vacinacao_via_adm7'], (220, 579), font_size=12) # Via de administração da vacina7
    document.write_text(dict_especifico['vacinacao_via_adm8'], (220, 591), font_size=12) # Via de administração da vacina8
    document.write_text(dict_especifico['vacinacao_via_adm9'], (220, 603), font_size=12) # Via de administração da vacina9
    ###Coluna 5
    document.write_text(dict_especifico['vacinacao_local_aplic1'], (282, 505), font_size=12) # Local de aplicação da vacina1
    document.write_text(dict_especifico['vacinacao_local_aplic2'], (282, 517), font_size=12) # Local de aplicação da vacina2
    document.write_text(dict_especifico['vacinacao_local_aplic3'], (282, 530), font_size=12) # Local de aplicação da vacina3
    document.write_text(dict_especifico['vacinacao_local_aplic4'], (282, 543), font_size=12) # Local de aplicação da vacina4
    document.write_text(dict_especifico['vacinacao_local_aplic5'], (282, 555), font_size=12) # Local de aplicação da vacina5
    document.write_text(dict_especifico['vacinacao_local_aplic6'], (282, 567), font_size=12) # Local de aplicação da vacina6
    document.write_text(dict_especifico['vacinacao_local_aplic7'], (282, 579), font_size=12) # Local de aplicação da vacina7
    document.write_text(dict_especifico['vacinacao_local_aplic8'], (282, 591), font_size=12) # Local de aplicação da vacina8
    document.write_text(dict_especifico['vacinacao_local_aplic9'], (282, 603), font_size=12) # Local de aplicação da vacina9
    ###Coluna 6
    ...
    ###Coluna 8
    document.write_date(dict_especifico['vacinacao_dt_valid1'], (497, 505), font_size=10, printbars=True) # Data de validade da vacina1
    document.write_date(dict_especifico['vacinacao_dt_valid2'], (497, 517), font_size=10, printbars=True) # Data de validade da vacina2
    document.write_date(dict_especifico['vacinacao_dt_valid3'], (497, 530), font_size=10, printbars=True) # Data de validade da vacina3
    document.write_date(dict_especifico['vacinacao_dt_valid4'], (497, 543), font_size=10, printbars=True) # Data de validade da vacina4
    document.write_date(dict_especifico['vacinacao_dt_valid5'], (497, 555), font_size=10, printbars=True) # Data de validade da vacina5
    document.write_date(dict_especifico['vacinacao_dt_valid6'], (497, 567), font_size=10, printbars=True) # Data de validade da vacina6
    document.write_date(dict_especifico['vacinacao_dt_valid7'], (497, 579), font_size=10, printbars=True) # Data de validade da vacina7
    document.write_date(dict_especifico['vacinacao_dt_valid8'], (497, 591), font_size=10, printbars=True) # Data de validade da vacina8
    document.write_date(dict_especifico['vacinacao_dt_valid9'], (497, 603), font_size=10, printbars=True) # Data de validade da vacina9
    ###################################################
    ...
    document.write_date(dict_especifico['dt_vac_durante_viagem'], (315, 249),spacing=1, pg=1, font_size=10, printbars=True) # Data da vacina durante viagem
    ...
    document.write_cross(dict_especifico['mani_loc_linfadenite_nao_sup'], (235, 323), pg=1, font_size=9) # linfadenite nao supurada
    document.write_cross(dict_especifico['mani_loc_linfadenite_sup'], (235, 331), pg=1, font_size=9) # linfadenite supurada
    #coluna 3
    document.write_cross(dict_especifico['mani_loc_linfa3cm'], (390, 283), pg=1, font_size=9) # linfadenomegalia >3cm
    document.write_cross(dict_especifico['mani_loc_linfa_nao_sup'], (390, 291), pg=1, font_size=9) # linfadenomegalia nao supurada
    ...
    document.write_date(dict_especifico['dt_sint_locais'], (60, 358),spacing=1, pg=1, font_size=12) # data dos sintomas
    document.write_text(dict_especifico['dia_vac_manif_loc'], (178, 358), pg=1, font_size=12) # dias vacina manifestacao local
    document.write_text(dict_especifico['hr_vac_manif_loc'], (218, 358), pg=1, font_size=12) # horas vacina manifestacao local
    document.write_text(dict_especifico['min_vac_manif_loc'], (264, 358), pg=1, font_size=12) # minutos vacina manifestacao local
    ...
    document.write_cross(dict_especifico['mani_sis_hiper'], (234, 398), pg=1, font_size=9) # hiperemia e coceira nos olhos
    document.write_cross(dict_especifico['mani_sis_urti_gener'], (390, 398), pg=1, font_size=9) # urticaria generalizada
    #Linha 3
    ...
    document.write_cross(dict_especifico['mani_sis_conv_toni'], (234, 503), pg=1, font_size=9) # convulsão tônico-clônica
    document.write_cross(dict_especifico['mani_sis_paresia'], (390, 503), pg=1, font_size=9) # paresia
    #Linha 2
    document.write_cross(dict_especifico['mani_sis_nivel_consc'], (86, 511), pg=1, font_size=9) # alteração do nível de consciência
    ...
    document.write_cross(dict_especifico['mani_sis_sin_neuro'], (390, 527), pg=1, font_size=9) # sinais neurológicos focais
    #Linha 5
    document.write_cross(dict_especifico['mani_sis_conv_focal'], (86, 535), pg=1, font_size=9) # convulsão focal
    document.write_cross(dict_especifico['mani_sis_nao_resposta'], (234, 535), pg=1, font_size=9) # não resposta a estímulos
    ...
    document.write_cross(dict_especifico['mani_sis_inva_intest'], (234, 568), pg=1, font_size=9) # invaginação intestinal
    ...
    document.write_text(dict_especifico['dia_vac_manif_sistem'], (178, 602), pg=1, font_size=12) # dias vacina manifestacao sistêmica
    document.write_text(dict_especifico['hr_vac_manif_sistem'], (218, 602), pg=1, font_size=12) # horas vacina manifestacao sistêmica
    document.write_text(dict_especifico['min_vac_manif_sistem'], (264, 602), pg=1, font_size=12) # minutos vacina manifestacao sistêmica
    ...
    document.write_cross(dict_especifico['otr_mani_evi_sang'], (234, 623), pg=1, font_size=9) # evidencia de sangramento
    ...
    #Linha 6
    document.write_cross(dict_especifico['otr_mani_dif_deamb'], (86, 663), pg=1, font_size=9) # dificuldade de deambulação
    ...
    document.write_text(dict_especifico['dia_vac_manif_otr_mani'], (185, 697), pg=1, font_size=12) # dias vacina manifestacao outras
    document.write_text(dict_especifico['hr_vac_manif_otr_mani'], (226, 697), pg=1, font_size=12) # horas vacina manifestacao outras
    document.write_text(dict_especifico['min_vac_manif_otr_mani'], (274, 697), pg=1, font_size=12) # minutos vacina manifestacao outras
    ...
    document.write_date(dict_especifico['dt_col_hemograma'], (216, 73), pg=2, spacing=1, font_size=10, printbars=True) # data da coleta do hemograma
    ...
    document.write_date(dict_especifico['dt_col_bioquimica'], (173, 129), pg=2, spacing=1, font_size=8, printbars=True) # data da coleta da bioquimica

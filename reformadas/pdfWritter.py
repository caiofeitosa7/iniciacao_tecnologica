...
class PDFWriter:
    ...
    def write_text(self, text: str, pos: tuple, pg: int = 0, color=(1, 0, 0), font_size=None):
        if font_size is None: font_size = self.default_font_size
    ...
    def save(self, file_name: str, dictcsv: dict = None):
        """
        ...
        if dictcsv:
            notificatoria = generateFicha(dictcsv)

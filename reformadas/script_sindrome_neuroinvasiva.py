...
if especifico['tipo_notificacao2'] == '1':
    doc.write_cross((167, 115))
else:
    doc.write_cross((310, 115))

doc.write_mini(especifico['agravoDoenca_num'], (420, 136))  #agravo doenca numerico
doc.write_text(especifico['agravoDoenca_outro'], (168, 146), font_size=8)  #agravo doenca outro
...
doc.write_text(especifico['dt_hospitalizacao2'], (82, 196))  #data_hospitalizacao2
doc.write_text(especifico['serv_vigilancia'], (200, 196), font_size=9)  #servico_vigilancia
...
doc.write_text(especifico['nome_mae2'], (245, 321), font_size=9)  #nome_mae
##############################################
#####          DADOS DE RESIDENCIA        ####
##############################################

doc.write_uf(especifico['uf_residencia2'], (68, 350))  #uf_residencia
doc.write_text(especifico['municipio_residencia2'], (100, 349), font_size=8)  #municipio_residencia
...
doc.write_text(especifico['bairro_residencia2'], (75, 373), font_size=8)  #bairro
doc.write_text(especifico['logradouro_residencia2'], (210, 373), font_size=8)  #logradouro
...
doc.write_text(especifico['complemento_residencia2'], (145, 397), font_size=8)  #complemento
...
doc.write_text(especifico['pais_residencia2'], (370, 421), font_size=8)  #pais
###################################################
# Dados Complementares _ Ficha de Investigação    #
###################################################
doc.write_date(especifico['dt_investigacao'], (73, 463), spacing=2)  #data_investigacao
doc.write_text(especifico['ocupacao'], (200, 463), font_size=8)  #ocupacao
...
doc.write_text(especifico['destino_viagem'], (325, 490), font_size=8)  #destino_viagem
...
doc.write_text(especifico['infec_outro_descricao'], (232, 569), font_size=7)  #infec_outro_descricao
...
doc.write_text(especifico['dados_vacinacao'], (400, 605), font_size=7)  #dados_vacinacao
...
doc.write_text(especifico['diag_alta'], (230, 689), font_size=6)  #diagnostico_alta
...
doc.write_text(especifico['diag_etiol_outro_descricao'], (98, 726), font_size=6)  #diagnostico_etiologico_outro
